...
The C++ output is committed to the repository so it is always available without
...
Usage:
  python source/slang-wasm-lib/tools/generate-slang-bindings.py [--slang-h PATH] [--cpp-out PATH] [--java-out DIR] [--java-package PKG]
