...
public enum TypeKind {
    NONE(0), STRUCT(1), ARRAY(2), MATRIX(3), VECTOR(4), SCALAR(5), CONSTANT_BUFFER(6), RESOURCE(7), SAMPLER_STATE(8), TEXTURE_BUFFER(9), SHADER_STORAGE_BUFFER(10), PARAMETER_BLOCK(11), GENERIC_TYPE_PARAMETER(12), INTERFACE(13), OUTPUT_STREAM(14), MESH_OUTPUT(15), SPECIALIZED(16), FEEDBACK(17), POINTER(18), DYNAMIC_RESOURCE(19), ENUM(20);
